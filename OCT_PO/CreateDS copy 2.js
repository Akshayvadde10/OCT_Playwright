...
class CreateDS
{
    ...
    async createDataset(DatasetName, UniqueEntityName, GrpEntityName = null)
    {
    ...
    // Use Group Entity if provided, otherwise use UniqueEntityName
    const entityToSelect = GrpEntityName || UniqueEntityName;
...
const calculationCell = this.frame.locator('div.wj-row').filter({ hasText: entityToSelect })
